        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                @if (strtolower(session('name_user')) == 'codero')
                    <li class="nav-item">
                        <a  href="//{{ session('role') }}/section"
                            {{-- href="/{{ session('role') }}/course/" --}}
                            class="nav-link {{ session('page') && session('page')->page ? (session('page')->page == 'eca' ? 'active' : '') : '' }}">
                            <i class="">
                ...
                @else
                    <!-- DASHBOARD -->
                        ...
                        @elseif (session('role') == 'student' || session('role') == 'parent')
                            @if (session('is_final_exam') === true)
                                <li class="nav-item">
                                    <a href="{{ url('/' . session('role') . '/dashboard/finalExam') }}"
                                        class="nav-link {{ session('page') && session('page')->page == 'assessment' ? 'active' : '' }}">
                                        <i class="">
                                            <img loading="lazy" src="{{ asset('images/assessment.png') }}" class="" alt="User Image"
                                                style="width: 32px; height: 32px; object-fit: cover;">
                                        </i>
                                        <p class="text-bold ">Final Exam</p>
                                    </a>
                                </li>
                            @else
                                <li class="nav-item">
                        ...
                        @else
                            ...
                            @else
                                ...
                                @if (session('role') == 'student' || session('role') == 'parent')
                                    <li class="nav-item">
                                        <a href="/{{ session('role') }}/eca/section"
                                            class="nav-link {{ session('page') && session('page')->page ? (session('page')->page == 'eca' ? 'active' : '') : '' }}">
                                            <i class="">
                                                <img loading="lazy" src="{{ asset('images/eca.png') }}" class="" alt="User Image"
                                                    style="width: 32px; height: 32px; object-fit: cover;">
