   ...
   <!-- Content Wrapper. Contains page content -->
       <div class="container-fluid">
           <h2 class="text-center display-4">Student Search</h2>
            <form class="mt-5" action="/{{ session('role') }}/list">
               <div class="row">
        ...
        <div class="d-flex justify-content-end my-5">
            ...
            <nav aria-label="...">
                <ul class="pagination" max-size="2">
                        ...
                        @php
                        $link= '/'.session('role').'/list?type='.$selectedType.'&grade_id='.$selectedGrade.'&sort='.$selectedSort.'&order='.$selectedOrder.'&status='.$selectedStatus.'&search='.$form->search;
