            ...
            <div class="col-md-12">
                ...
                <div>
                    ...
                    @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date"
                                                ...
                                                <input name="date_of_registration" type="text" class="form-control "
                                                    placeholder="dd/mm/yyyy" data-mask
                                                    value="{{old('date_of_registration') ? date("d/m/Y", strtotime(old('date_of_registration'))) : date("d/m/Y", strtotime($data->student->date_of_registration))}}" />
                        ...
                        @if(count($data->student->relationship) > 0)
                            {{-- CARD FATHER --}}
                            @if($father !== null)
                                <div class="card card-dark">
                                    <div class="card-header">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input name="fatherId_or_passport" type="text" class="form-control"
                                                    ...
                                                    value="{{$father->id_or_passport ? $father->id_or_passport : ''}}"
                                                    required>
                                                @if($errors->any())
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input name="fatherOccupation" type="text" class="form-control"
                                                    ...
                                                    value="{{$father->occupation ? $father->occupation : ''}}">
                                                @if($errors->any())
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="fatherReligion" class="form-control" required>
                                                    ...
                                                    $arrReligion = array('Islam', 'Protestant Christianity', 'Catholic
                                                    Christianity', 'Hinduism', 'Buddhism', 'Confucianism', 'Others');
                                                    $father_religion = $father->religion ? $father->religion :
                                                    '';
                                                    @endphp
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input name="fatherPlace_birth" type="text" class="form-control"
                                                    ...
                                                    value="{{$father->place_birth ? $father->place_birth : ''}}"
                                                    required>
                                                @if($errors->any())
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group date" id="reservationFatherBirthDate"
                                                    ...
                                                    <input name="fatherBirth_date" type="text"
                                                        ...
                                                        data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy"
                                                        data-mask required
                                                        {{-- value="{{$father->date_birth ? date("d-m-Y", strtotime($father->date_birth)) : ''}}" --}}
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input name="fatherNationality" type="text" class="form-control"
                                                    ...
                                                    value="{{$father->nationality ? $father->nationality : ''}}"
                                                    required>
                                                @if($errors->any())
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="fatherCompany_name" type="text" class="form-control"
                                                ...
                                                value="{{$father->company_name ? $father->company_name : ''}}">
                                            @if($errors->any())
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input name="fatherCompany_address" type="text" class="form-control"
                                                    ...
                                                    value="{{$father->company_address ? $father->company_address : ''}}">
                                                @if($errors->any())
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input name="fatherCompany_phone" type="text" class="form-control"
                                                    ...
                                                    value="{{$father->phone ? $father->phone : ''}}">
                                                @if($errors->any())
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="fatherHome_address" type="text" class="form-control"
                                                ...
                                                value="{{$father->home_address ? $father->home_address : ''}}">
                                            @if($errors->any())
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-4">
                                                ...
                                                <input name="fatherTelephhone" type="text" class="form-control"
                                                    ...
                                                    value="{{$father->telephone ? $father->telephone : ''}}">
                                                @if($errors->any())
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input name="fatherMobilephone" type="text" class="form-control"
                                                    ...
                                                    value="{{$father->mobilephone ? $father->mobilephone : ''}}">
                                                @if($errors->any())
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input name="fatherEmail" type="email" class="form-control"
                                                        ...
                                                        value="{{$father->email ? $father->email : ''}}"
                                                        required>
                                                    @if($errors->any())
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input name="motherName" type="text" class="form-control" id="motherName"
                                                    ...
                                                    value="{{$mother->name ? $mother->name : ''}}" required>
                                                @if($errors->any())
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input name="motherId_or_passport" type="text" class="form-control"
                                                    ...
                                                    value="{{$mother->id_or_passport ? $mother->id_or_passport : ''}}"
                                                    required>
                                                @if($errors->any())
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input name="motherOccupation" type="text" class="form-control"
                                                    ...
                                                    value="{{$mother->occupation ? $mother->occupation : ''}}">
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <select name="motherReligion" class="form-control" required>
                                                    ...
                                                    $arrReligion = array('Islam', 'Protestant Christianity', 'Catholic
                                                    Christianity', 'Hinduism', 'Buddhism', 'Confucianism', 'Others');
                                                    $mother_religion = $mother->religion ? $mother->religion : '';
                                                    @endphp
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input name="motherPlace_birth" type="text" class="form-control"
                                                    ...
                                                    value="{{$mother->place_birth ? $mother->place_birth : ''}}"
                                                    required>
                                                @if($errors->any())
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group date" id="reservationMotherBirthDate"
                                                    ...
                                                    <input name="motherBirth_date" type="text"
                                                        ...
                                                        data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy"
                                                        data-mask
                                                        value="{{$mother->date_birth ? date("d/m/Y", strtotime($mother->date_birth)) : ''}}"
                                                        required />
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input name="motherNationality" type="text" class="form-control"
                                                    ...
                                                    value="{{$mother->nationality ? $mother->nationality : ''}}"
                                                    required>
                                                @if($errors->any())
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="motherCompany_name" type="text" class="form-control"
                                                value="{{$mother->company_name ? $mother->company_name : ''}}"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input name="motherCompany_address" type="text" class="form-control"
                                                    ...
                                                    value="{{$mother->company_address ? $mother->company_address : ''}}">
                                                @if($errors->any())
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input name="motherCompany_phone" type="text" class="form-control"
                                                    ...
                                                    value="{{$mother->phone ? $mother->phone : ''}}">
                                                @if($errors->any())
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="motherHome_address" type="text" class="form-control"
                                                ...
                                                value="{{$mother->home_address ? $mother->home_address : ''}}"
                                                required>
                                            @if($errors->any())
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-4">
                                                ...
                                                <input name="motherTelephhone" type="text" class="form-control"
                                                    ...
                                                    value="{{$mother->telephone ? $mother->telephone : ''}}">
                                                @if($errors->any())
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input name="motherMobilephone" type="text" class="form-control"
                                                    ...
                                                    value="{{$mother->mobilephone ? $mother->mobilephone : ''}}">
                                                @if($errors->any())
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input name="motherEmail" type="email" class="form-control"
                                                        ...
                                                        value="{{$mother->email ? $mother->email : ''}}"
                                                        required>
                                                    @if($errors->any())
                ...
                <div class="d-flex justify-content-center">
                    <button type="submit" class="col-12 btn btn-success">Update Student Profile</button>
                </div>
                </form>
...
@if(session('after_update_student')) 
    <script>
        Swal.fire({
            icon: 'success',
            title: 'Successfully edit data student',
        });
    </script>
@endif
@endsection
