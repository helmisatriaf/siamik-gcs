        ...
        <div class="row">
            <nav>
                <div class="nav nav-tabs mb-4" id="nav-tab" role="tablist">
                    <a href="#" id="newYear" class="nav-item nav-link active text-[8px] md:text-[12px] lg:text-[14px] xl:text-[16px]" onclick="toggleInput('newYear')" style="hover:cursor-pointer">New Academic Year</a>
                    <a href="#" id="inMiddle" class="nav-item nav-link text-[8px] md:text-[12px] lg:text-[14px] xl:text-[16px]" onclick="toggleInput('inMiddle')" style="hover:cursor-pointer">In The Middle Semester</a>
                </div>
            </nav>
            <div class="col-md-12" id="form-new-year">
            ...
            <div class="col-md-12" id="form-in-middle" style="display:none;">
                <!-- general form elements -->
                <div>
                @if (session('role') == 'superadmin')
                    <form method="POST" action={{route('actionRegisterSuperInMiddle')}}>
                @endif
                        @csrf
                        <div class="card card-secondary">
                            <div class="card-header">
...
<script>
    function toggleInput(type) {
        const newYearTab = document.getElementById("newYear");
        const inMiddleTab = document.getElementById("inMiddle");

        const newYearInput = document.getElementById("form-new-year");
        const inMiddleInput = document.getElementById("form-in-middle");

        if (type === 'newYear') {
            newYearInput.style.display = 'block';
            inMiddleInput.style.display = 'none';
            newYearTab.classList.add("active");
            inMiddleTab.classList.remove("active");
        } else {
            newYearInput.style.display = 'none';
            inMiddleInput.style.display = 'block';
            newYearTab.classList.remove("active");
            inMiddleTab.classList.add("active");
        }
    }
</script>
