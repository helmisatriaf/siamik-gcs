...
<div class="card card-light">
    ...
    <div class="card-body">
        <div class="row">
                        ...
                        <div class="inner">
                            @if (session('role') == 'teacher')
                                <a class="small-box bg-warning d-flex flex-column align-items-center justify-content-center text-center"
                                    style="min-height: 110px;" data-bs-toggle="modal" data-bs-target="#ebook"
                                    href="">
                            ...
                            @else
                                <a href="{{ route('subject.create-section.super', [
                                    ...
                                    class="small-box bg-info justfify-content-center text-align-center"
            ...
            @else
                <div class="col-md-3 col-6">
                    <div class="small-box bg-orange px-2 d-flex flex-column zoom-hover position-relative justify-content-center align-items-center"
                        style="min-height: 110px;">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Delete Acvity
                                                    {{ ucwords($activity->title) }}</h5>
                        ...
                        @if ($assessments->count() > 0)
                            @foreach ($assessments as $assessment)
                                ...
                                @if ($assessment->hasFile == 1)
                                    <div
                                        class="activity-item mb-2 p-4 border rounded bg-light d-flex flex-column position-relative">
                        ...
                        <div class="mb-3">
                            @if (in_array(session('role'), ['admin', 'superadmin', 'teacher']))
                                <button type="button"
                                    ...
                                    style="color: #007bff; border-color: #007bff; background-color: transparent; transition: all 0.3s ease;"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <div class="file-upload-wrapper">
                                        ...
                                        <div class="selected-file-info p-3 mt-2 d-none" id="file-info">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="d-flex align-items-center">
                                                    <i class="fas fa-file-pdf text-danger me-2"></i>
                                                    <span class="file-name text-truncate" id="file-name">No file
                                                        selected</span>
                                                </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            <i class="fas fa-trash mr-2"></i>Delete E-Book File
                        </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true"><i class="fas fa-times"></i></span>
                        </button>
...
@if (session('succes_delete_ebook'))
    <script>
        Swal.fire({
            icon: 'success',
