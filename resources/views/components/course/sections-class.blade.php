...
<style>
    ...
    .file-upload-area, .file-upload-area-change {
        cursor: pointer;
    }
                        ...
                        <div class="col-md-3 col-6">
                            <div class="inner">
                                <a href="{{ route('subject.create-section.super', [
                                    ...
                                    <i class="fas fa-plus"></i> Ebook Empty
                                </a>
                            </div>
                        </div>
                    @endif
    ...
    <div id="sections-container">
        @foreach ($course as $section => $month)
            <div class="section shadow-soft" style="background-color: #ffde9e;">
                <div class="section-header d-flex justify-content-start align-items-center" onclick="toggleSection(this)">
