        ...
        <div>
            <table class="table">
                ...
                <tr>
                    ...
                    <td style="border: 1px solid black;padding-left:4px;" colspan="2">{{ $attendance[0]['days_absent'] }} {{ $attendance[0]['days_absent'] == 1 ? 'day' : 'day(s)' }}</td>
                    <td style="text-align:right;border: 1px solid black;padding-right:4px;" colspan="2">Total Days Absent:</td>
                    <td style="border: 1px solid black;padding-left:4px;border-right: solid 1px black;" colspan="2">{{ $attendance[0]['days_absent'] }} {{ $attendance[0]['days_absent'] == 1 ? 'day' : 'day(s)' }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="8" style="font-style: italic;border-bottom: 1px solid black;text-align:left;padding-left: 5px;border-left: solid 1px black;border-right: solid 1px black;">
                        {{ $learningSkills->strength_weakness_nextstep }}
                    </td>
                </tr>
                <!-- END LEARNING SKILLS -->
