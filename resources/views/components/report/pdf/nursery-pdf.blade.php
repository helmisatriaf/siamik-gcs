...
<div class="container header"> 
    ...
    <div style="margin-top:5px;">
        ...
        <table class="table border-solid-black" style="margin-top:5px;">
            <tr>
                <td style="text-align:left;width:70%;border:none;padding-left:15px;font-size:12px;"><b>Able to Recognize</b> <span class="noto-serif-sc-chinese"><b>能够理解</b></span></td>
                <td style="text-align:center;width:10%;border:none;"></td>
                <td style="text-align:center;width:10%;border:none;"></td>
                <td style="text-align:center;width:10%;border:none;"></td>
            </tr>
            <tr>
                <td style="text-align:left;width:70%;border: 1px solid black;padding-left:3px;font-size:10px;;">Colour <span class="noto-serif-sc-chinese"><b>颜色</b></span></td>
                <td style="text-align:center;width:10%;border: 1px solid black;padding-left:3px;" class="noto-serif-sc-simbol">
                    @if ($score->colour == 1)
                        √
                    @endif
        ...
        @if ($mid == 0.5 || $mid == 1.5)
            ...
            <table class="table border-solid-black" style="margin-top:5px;">
                ...
                @foreach ($scoreMonthly as $monthly)
                    <tr>
                        <td style="text-align:left;width:70%;border: 1px solid black;padding-left:3px;font-size:10px;font-size:10px;">{{ $monthly['name_activity'] }} 
    ...
    <div class="header">
        <table class="table">
            ...
            <tr>
                <td style="text-align:center;padding-top:12px;font-size:12px;font-color:black;"colspan="2"><i>This report card is for internal circulation only.</i></td>
            </tr>
            {{-- <tr>
    ...
    <div class="footer" style="margin-top: 10px;text-align:center;">
        <img src="<?= $cambridge ?>" style="width:50%;height:8%;">
    </div>
    <!-- END PAGE 2 -->
</div>
